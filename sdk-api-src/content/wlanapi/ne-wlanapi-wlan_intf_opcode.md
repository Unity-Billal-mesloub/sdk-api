...
The opcode used to set or query the current operation mode of the wireless interface. For more information about operation modes, see <a href="https://learn.microsoft.com/en-us/previous-versions/windows/hardware/wireless/native-802-11-operation-modes">Native 802.11 Operation Modes</a>.
