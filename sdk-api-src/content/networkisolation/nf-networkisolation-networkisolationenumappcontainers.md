...
description: The NetworkIsolationEnumAppContainers function enumerates all of the app containers that have been created in the system. (NetworkIsolationEnumAppContainers)
