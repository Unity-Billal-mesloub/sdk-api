---
UID: NF:fileapi.RemoveDirectory2W
tech.root: fs
title: RemoveDirectory2W function (fileapi.h)
ms.date: 04/10/2025
targetos: Windows
...
To perform this operation as a transacted operation, use the [RemoveDirectoryTransacted](../winbase/nf-winbase-removedirectorytransactedw.md) function.
...
The use of POSIX delete causes the directory to be deleted while handles remain open. Subsequent calls to [CreateDirectory](nf-fileapi-createdirectoryw.md) or [CreateDirectory2](nf-fileapi-createdirectory2w.md) to open the directory fail with **ERROR_FILE_NOT_FOUND**.
...
[RemoveDirectoryTransacted](../winbase/nf-winbase-removedirectorytransactedw.md)
